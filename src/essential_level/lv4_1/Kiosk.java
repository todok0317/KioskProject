            ...
            while (true) {
                ...
                if (answer1 == 0) {
                    ...
                    if (answer1 == 1) {
                        ...
                        System.out.println("-----------------------------------------------------------------------");
                        for (int i = 0; i < menu.getHamburgerList().size(); i++) {
                            MenuItem item = menu.getHamburgerList().get(i);
                        ...
                        while (true) {
                            ...
                            if (answer2 == 0) {
                                break;
                            } else if (answer2 >= 1 && answer2 <= menu.getHamburgerList().size()) {
                                MenuItem selectedItem = menu.getHamburgerList().get(answer2 - 1);
